                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="d-flex flex-column vote-controls">
                            ...
                            <a title="Click to mark as favorite(Click again to undo)" class="favorite mt-2 favorited"><i class="fas fa-star fa-2x"></i></a>
                    ...
                    @foreach($question->answers as $answer)
                        <div class="media">
                            <div class="d-flex flex-column vote-controls">
                                ...
                                <a title="Mark this as best answer" class="vote-accepted mt-2"><i class="fas fa-check fa-2x"></i></a>
                                <span class="favorites-count">123</span>
                            </div>
                            <div class="media-body">
                                {!! $answer->body_html !!}
